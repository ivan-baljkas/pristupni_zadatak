...
const handleSearch = (event) => {
  ...
  console.log('cijena: ', formState.placanje)
  ...
  return (
    <div>
      ...
      <SearchForm state={state}  handleSearch={handleSearch} handleChange={handleChange}/>
        ...
        <NarudzbaForm ukupnaCijena={state.ukupnaCijena} naciniPlacanja={state.naciniPlacanja} handleSelect={handleSelect}/>
    </div>
  );
};
