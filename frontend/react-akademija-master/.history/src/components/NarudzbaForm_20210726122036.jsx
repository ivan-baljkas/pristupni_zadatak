    ...
    return(
        <div>
            ...
            <div>
                ...
                <input type="text" id="kodZaPopust" name="kodZaPopust" onChange={props.handleQueryChange}/>
                
            </div>
            <div>
                <label for="placanje">Odaberi način plaćanja:</label>
                <select name="placanje" id="placanje" onChange={props.handleSelect}>
            ...
            <div>
                ...
                <input type="text" id="brojKartice" name="brojKartice" onChange={props.handleQueryChange}/>
